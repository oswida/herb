...
export const CardStackComponent = track(
  ({ shape }: CardStackComponentProps) => {
    ...
    const drawCard = () => {
      if (shape.props.current.length === 0) {
        addToast({
          id: "1",
    ...
    return (
      ...
      >
        ...
        {shape.props.cardBackUrl !== "" && (
          <img
            src={shape.props.cardBackUrl}
            style={{ width: shape.props.w, height: shape.props.h }}
          />
        )}
        {shape.props.cardBack === "" && (
          ...
          <>
            ...
            {isOwner && (
              <Button
                type="icon"
                title="Settings"
                style={{ position: "absolute", left: "45%", bottom: -60 }}
...
export class CardStackShapeUtil extends BaseBoxShapeUtil<ICardStackShape> {
  ...
  indicator(shape: ICardStackShape) {
    return <rect width={shape.props.w} height={shape.props.h + 20} />;
  }
